...
//	eigen
#if defined(EIGEN_CORE_H) && defined(EIGEN_LU_MODULE_H) && defined(EIGEN_CHOLESKY_MODULE_H) && defined(EIGEN_QR_MODULE_H) && defined(EIGEN_SVD_MODULE_H) && defined(EIGEN_GEOMETRY_MODULE_H) && defined(EIGEN_EIGENVALUES_MODULE_H)
